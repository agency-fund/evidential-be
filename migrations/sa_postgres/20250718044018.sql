...
-- Modify "draws" table
ALTER TABLE "public"."draws" DROP CONSTRAINT "draws_pkey", ADD COLUMN "participant_id" character varying(255) NOT NULL, ADD COLUMN "participant_type" character varying(255) NOT NULL, ADD PRIMARY KEY ("participant_id"), DROP COLUMN "id", ALTER COLUMN "observed_at" DROP DEFAULT;
