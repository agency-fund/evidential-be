...
@router.put(
    "/datasources/{datasource_id}/experiments/{experiment_id}/turn-journey-mapping",
    status_code=status.HTTP_204_NO_CONTENT,
)
...
@router.get("/datasources/{datasource_id}/experiments/{experiment_id}/turn-journey-mapping")
