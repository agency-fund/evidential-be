...
def build_experiment_assignments_copy_query(experiment_id: str, strata_names: list[str]):
    strata_columns = []
...
def validate_experiment_assignments_csv_export(experiment: tables.Experiment) -> None:
...
async def get_experiment_assignments_as_csv_impl(
    ...
    validate_experiment_assignments_csv_export(experiment)
    strata_names = get_assignment_csv_strata_names_from_experiment(experiment)
    copy_query = build_experiment_assignments_copy_query(experiment.id, strata_names)
