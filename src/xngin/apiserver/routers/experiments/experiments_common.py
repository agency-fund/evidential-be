...
async def fetch_fields_or_raise(
    ...
    async with DwhSession(datasource.get_config().dwh) as dwh:
        ...
        return fetch_fields_from_table_or_raise(sa_table, design_spec)


def fetch_fields_from_table_or_raise(table: Table, design_spec: AnyFrequentistDesignSpec) -> dict[str, DataType]:
