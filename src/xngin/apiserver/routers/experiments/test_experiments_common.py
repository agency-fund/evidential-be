                    ...
                    "arms": [
                        {
                            **({"arm_id": arm1_id} if arm1_id is not None else {}),
                            ...
                            "alpha_init": 10.0 if prior_type == PriorTypes.BETA else None,
                            "beta_init": 10.0 if prior_type == PriorTypes.BETA else None,
                        ...
                        },
                        {
                            **({"arm_id": arm2_id} if arm2_id is not None else {}),
                            ...
                            "mu_init": -5.0 if prior_type == PriorTypes.NORMAL else None,
                            "sigma_init": 1.0 if prior_type == PriorTypes.NORMAL else None,
                        },
                    ],
                }
